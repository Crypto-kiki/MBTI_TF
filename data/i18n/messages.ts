...
> = {
  ...
  'zh-TW': {
    ...
    result: {
      axis: { f: 'F 傾向', t: 'T 傾向', balanced: '平衡型' }, summaryCard: '結果重點', summaryHint: '根據你的作答分數和常出現的線索，整理出目前的解讀風格。', totalF: 'F 分數', totalT: 'T 分數', answered: '作答數', fHint: '更靠近感受與關係的一側', tHint: '更靠近判斷與結構的一側', answeredHint: '實際完成的題數', strengths: '目前的優勢', tips: '可試著這樣做', finalBadge: '你的結果', goodMatch: '和我很合的類型', goodMatchReason: '合拍原因', cta: '一句提醒', backHome: '回到最初', tryOther: '也試試另一種模式', share: { badge: 'SHARE YOUR CARD', title: '把我的結果卡分享出去', hint: '直接把這張結果卡傳給朋友，一起比較看看。', previewLabel: '分享預覽', share: '立即分享', shareHint: '附上推薦文案分享', copy: '複製連結', copyHint: '複製文案 + 連結', copied: '已複製分享文案與連結。', failed: '無法複製連結。', shared: '已開啟結果卡分享。', templates: ['我在 F 與 T 之間測出 {title}，你也來試試看。', '我的結果是 {title}。你會是哪一型？'] },
    },
